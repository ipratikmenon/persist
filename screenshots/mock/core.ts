// Real shipped manifests, imported rather than pasted.
//
// They were inlined once and went stale the first time a field was added to the
// notice: the harness went on drawing a form the app no longer has. Vite
// resolves these at build time, so the screenshots are always of the real
// thing.
import tm_examination_replyJson from '../../src-tauri/storage/templates/tm-examination-reply.json';
import invoiceJson from '../../src-tauri/storage/templates/invoice.json';
import legal_noticeJson from '../../src-tauri/storage/templates/legal-notice.json';
...
const TM_REPLY_MANIFEST: any = tm_examination_replyJson;

const INVOICE_MANIFEST: any = invoiceJson;
...
const LEGAL_NOTICE_MANIFEST: any = legal_noticeJson;
